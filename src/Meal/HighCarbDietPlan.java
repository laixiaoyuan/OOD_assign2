 ...
 * allow user to generate a high carb diet plan for one day
...
public class HighCarbDietPlan implements DietPlan {
    ...
    /**
     * generate a lunch meal and a dinner meal randomly for high carb diet
     *
     ...
     *
     */
    public HighCarbDietPlan(String filename, Integer dayOfWeek) throws IOException {
        ...
        if (this.highCarbMeal.showRecipes().size() != 0) {
            this.lunch = new Lunch(this.highCarbMeal);
            this.dinner = new Dinner(this.highCarbMeal);
            int counter = 0;
